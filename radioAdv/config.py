...
class Config(object):
    def __init__(self):
        ...
        ##########################模型参数
        self.VTCNN2 = dict(
            filepath = './model/VTCNN2_Epoch190.pkl'
            # filepath = './checkpoint/Rml2016_10a_VTCNN2_V1/VTCNN2_Epoch500.pkl'
        )
        # self.VTCNN2 = dict(
        ...
        self.Based_LSTM = dict(
            filepath = './model/Based_LSTM_Epoch12.pkl'
        )
        self.Based_VGG = dict(
            filepath = './model/VTCNN2_Epoch190.pkl'
        )
        ...
        self.Rml2016_10a = dict(
            dirname = "./data_loader/dataset/RML2016.10a",  # 数据集文件路径
            prop = 0.5,                     # 所占的比例
            dataset_name = None,
        )
        ...
        self.Black_Attack = dict(
            threat_model = 'VTCNN2_18',
            black_model = 'Based_GRU_18',
            is_uap = False,
            eps = 0.002,
        )
    ...
    def load_parameter(self, parameter):
        ...
        for key, value in parameter.items():
            if hasattr(self, key) and isinstance(value, dict) and isinstance(getattr(self, key), dict):
